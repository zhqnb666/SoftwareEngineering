...
class ProfileManager:
    ...
    def get_profile(self, profile_id: int) -> Optional[Profile]:
        ...
        Returns:
            账户对象或 None
        """
        row = self.db.fetchone("SELECT * FROM profiles WHERE id = ?", (profile_id,))
    ...
    def get_profile_by_name(self, name: str) -> Optional[Profile]:
        ...
        Returns:
            账户对象或 None
        """
        row = self.db.fetchone("SELECT * FROM profiles WHERE name = ?", (name,))
    ...
    def list_profiles(self) -> List[Profile]:
        ...
        Returns:
            账户列表，按创建时间排序
        """
        rows = self.db.fetchall("SELECT * FROM profiles ORDER BY created_at ASC")
    ...
    def update_profile(
        self, profile_id: int, name: str = None, description: str = None
    ) -> bool:
        """更新账户信息
